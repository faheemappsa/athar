...
export const ATHAR_LIBRARY: AtharItem[] = [
  ...
  },
  {
    id: "dua-028",
    kind: "dua",
    text: "اللهم إني أعوذ برضاك من سخطك، وبمعافاتك من عقوبتك",
    source: "رواه مسلم",
    times: ["night", "any"],
    tags: ["rahmah", "raja"],
  },
  {
    id: "dua-029",
    kind: "dua",
    text: "اللهم إني أسألك حبك، وحب من يحبك، وحب عمل يقربني إلى حبك",
    source: "رواه الترمذي",
    times: ["night", "any"],
    tags: ["hidayah", "rahmah"],
  },
  {
    id: "dua-030",
    kind: "dua",
    text: "اللهم اجعلني لك شكاراً، لك ذكاراً، لك رهاباً، لك مطواعاً",
