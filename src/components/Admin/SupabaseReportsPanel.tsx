  ...
  return (
    <section className="relative overflow-hidden rounded-[36px] bg-white p-5 shadow-2xl shadow-action/10 ring-1 ring-action/10">
      ...
      <div className="relative flex items-start justify-between gap-3">
        <div><p className="text-sm font-black text-action">Supabase Live</p><h2 className="text-2xl font-black">غرفة قيادة أثر</h2><p className="mt-1 text-xs leading-6 text-secondary-text">مختصر حي لأهم مؤشرات أثر.</p></div>
